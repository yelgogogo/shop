...
export default {
  ...
  reducers: {
    ...
    setModal2Visible(state, { payload: { modal2Visible,modal2ErrMsg} } ) {
      return { ...state, modal2Visible,modal2ErrMsg};
    },
  ...
  effects: {
    ...
    *modify({ payload: { action} }, { call, put }) {
